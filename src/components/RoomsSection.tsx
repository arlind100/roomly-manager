    ...
    <section id="rooms" className="section-padding bg-gradient-dark">
      <div className="container-luxury">
        ...
        {loading ? (
          ...
          <p className="text-center text-muted-foreground">No rooms available at the moment.</p>
        ) : (
                  ...
                  <div className="relative h-64 overflow-hidden">
                    ...
                    <div className="absolute bottom-4 left-4 right-4 flex justify-between items-end">
                      ...
                      <span className="text-primary font-semibold text-lg">
                        ${Number(room.base_price)}<span className="text-sm text-muted-foreground">/night</span>
                      </span>
                    </div>
                  </div>
