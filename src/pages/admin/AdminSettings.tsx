...
import { Sun, Moon, Plus, Trash2, RefreshCw, ChevronDown, Rss, Globe } from 'lucide-react';
              ...
              return (
                <Collapsible key={feed.id}>
                  <div className="border border-border rounded-lg">
                    <CollapsibleTrigger className="flex items-center justify-between w-full p-3 hover:bg-muted/30 transition-colors text-left">
                    ...
                    <CollapsibleContent>
                      <div className="px-3 pb-3 space-y-3 border-t border-border pt-3">
                        <div>
                          ...
                          <p className="text-xs font-mono break-all bg-muted/30 rounded p-2 mt-1">{feed.ical_url}</p>
                        </div>
                        <div className="flex items-center justify-between">
                          <div>
