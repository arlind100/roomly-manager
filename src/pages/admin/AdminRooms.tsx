...
const STATUS_CONFIG: Record<string, { label: string; color: string; icon: any }> = {
  available: { label: 'Available', color: 'bg-green-50 text-green-700 border-green-200/60', icon: CheckCircle2 },
  occupied: { label: 'Occupied', color: 'bg-red-50 text-red-700 border-red-200/60', icon: DoorOpen },
  dirty: { label: 'Dirty', color: 'bg-amber-50 text-amber-700 border-amber-200/60', icon: Droplets },
  cleaning: { label: 'Cleaning', color: 'bg-blue-50 text-blue-700 border-blue-200/60', icon: Sparkles },
  maintenance: { label: 'Maintenance', color: 'bg-orange-50 text-orange-700 border-orange-200/60', icon: Wrench },
